...
font_small = pygame.font.Font('Assets/game_over.ttf', 20)
font_small_by_a_bit = pygame.font.Font('Assets/game_over.ttf', 18)
font_large = pygame.font.Font('Assets/game_over.ttf', 24)
font_extrasmall = pygame.font.Font('Assets/game_over.ttf', 14)
font_extra_extrasmall = pygame.font.Font('Assets/game_over.ttf', 10)

jumpy_image = pygame.image.load('Assets/jumpy.png').convert_alpha()

start_image = pygame.image.load('Assets/jumpy.png').convert_alpha()
...
bird_sheet_path = 'Assets/bird.png'
...
while startmenu:
    draw_bg(bg_scroll)
    draw_text('PRESS SPACE TO BEGIN', font_small_by_a_bit, white, 18, screen_height/2 - 100)
...
while run:
    ...
    if game_over == False:
        ...
        draw_text('HIGH SCORE', font_extrasmall, high_score_color, screen_width - 300, score - high_score_prev + scroll_thresh + 5)
